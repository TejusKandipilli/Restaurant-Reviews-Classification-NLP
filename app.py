...
with open('C:\\Users\\tejus\\Desktop\\6th Sem Project\\Restaurant Reviews (NLP)\\vectorizer.pkl', 'rb') as file:
...
loaded_model = pickle.load(open('C:\\Users\\tejus\\Desktop\\6th Sem Project\\Restaurant Reviews (NLP)\\trained_model.sav', 'rb'))
...
app = tk.Tk()
app.title("Restaurant Review Analysis App")
app.geometry("640x480")  # Set fixed size

# Create and place the label above the text entry box
label = tk.Label(app, text="Please give your review:", font=("Helvetica", 14))
label.pack(pady=10)
